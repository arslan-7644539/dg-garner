    ...
    <div>
      ...
      <div className="bg-gray-50 py-8 ">
        ...
        <section className="bg-white py-16">
          <div className="container mx-auto text-center">
            ...
            <p className="mt-4 text-lg text-gray-600">
              ...
              competitive prices. Our products are carefully selected to ensure
              premium features, support, and performance.
            </p>
            <div className="grid md:grid-cols-3 gap-8 mt-8">
              ...
              <div className="bg-blue-100 p-6 rounded-lg shadow-lg">
                ...
                <p className="mt-4 text-gray-600">
                  We offer competitive prices for premium products. Get the best
              ...
              <div className="bg-blue-100 p-6 rounded-lg shadow-lg">
                ...
                <p className="mt-4 text-gray-600">
                  ...
                  ensure smooth integration and functionality of your products.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="bg-blue-500 text-white py-8 text-center">
          ...
          <p className="mt-4 text-lg">
            Start building your website with our premium themes and plugins now.
